...
class MegazineController extends Controller
{
            ...
            ->addColumn('action', function($row){
                   ...
                   if ($row->status == '1') {
                    ...
                    if ($row->approval_status == '2') {
                        $btn .= '<a href="'.route('admin.megazine_approve',['megazine_id'=>encrypt($row->id),'status' => encrypt(1)]).'" class="btn btn-success btn-sm">Approve</a>';
    ...
    public function megazineApprove($megazine_id,$status)
    {
        try {
            $megazine_id = decrypt($megazine_id);
